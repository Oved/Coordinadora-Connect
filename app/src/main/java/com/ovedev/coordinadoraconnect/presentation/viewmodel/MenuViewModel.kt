...
class MenuViewModel @Inject constructor(
    ...
    private val _responseContinueInSession = MutableLiveData<Response<UserModel?>>()
    val responseContinueInSession: LiveData<Response<UserModel?>> get() = _responseContinueInSession
